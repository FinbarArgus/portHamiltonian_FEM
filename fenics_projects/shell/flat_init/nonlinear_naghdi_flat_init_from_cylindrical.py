...
# 
# ======================================================
# Clamped semi-cylindrical Naghdi shell under uniform 
# ======================================================
# 
# This demo program solves the nonlinear Naghdi shell equations for a
# semi-cylindrical shell loaded by a uniform pressure load. 
...
centre = Point(0.,0.)
ndiv = 21
geom = Circle(centre, r)
mesh = generate_mesh(geom, ndiv)
...
initial_shape = Expression(('x[0]','x[1]','0.0'), r=rho, degree = 4)
...
# This takes in spherical polar angles and returns a normal vector.
...
# This gives the normals in terms of spherical polar angles
...
plot_shell(phi0)
# Change to the following line to include the surface normals
...
#The boundaries are fully clamped around the outside of the circle...

out_boundary = lambda x, on_boundary: on_boundary
