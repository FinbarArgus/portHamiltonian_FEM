...
savePath = os.path.join('output', 'plots', 'emHamiltonianScipy.png')
fig.savefig(savePath, dpi=1000, bbox_inches='tight')
...
# plt.legend(loc='upper right', fontsize=10)
savePath = os.path.join('output', 'plots', 'emDisplacementError.png')
fig.savefig(savePath, dpi=1000, bbox_inches='tight')
# plt.show()
...
# plt.legend(loc='upper right', fontsize=10)
savePath = os.path.join('output', 'plots', 'emEnergyResidualFenics.png')
fig.savefig(savePath, dpi=1000, bbox_inches='tight')
